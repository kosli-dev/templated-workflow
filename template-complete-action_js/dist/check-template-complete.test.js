...
describe("findAttestations (mocked fs)", () => {
  ...
  test("should find all attestations with the specified status", () => {
    const found = (0, check_template_complete_1.findAttestations)(
      "dummy-path.json",
      "MISSING",
    );
  ...
  test("should return an empty array if the compliance_status or attestations_statuses are missing", () => {
    ...
    const found1 = (0, check_template_complete_1.findAttestations)(
      "dummy-path.json",
      "MISSING",
    );
    ...
    const found2 = (0, check_template_complete_1.findAttestations)(
      "dummy-path.json",
      "MISSING",
    );
  ...
  test("should throw an error if the JSON file does not exist", () => {
    ...
    expect(() =>
      (0, check_template_complete_1.findAttestations)(
