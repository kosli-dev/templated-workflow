...
interface ComplianceStatus {
    ...
    artifacts_statuses?: { // Optional object where keys are artifact names
        [key: string]: { // Index signature: allows arbitrary string keys
 ...
 */
export function findAttestations(jsonFilePath: string, statusToFind: string): string[] {
